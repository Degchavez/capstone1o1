<x-app-layout>
    <div class="max-w-6xl mx-auto px-4 py-6">
            ...
            <div class="flex items-center space-x-8">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600 dark:text-neutral-400 mt-2 flex items-center space-x-2">
                        ...
                        <a href="{{ route('owners.profile', ['owner_id' => $animal->owner->owner_id]) }}" class="text-blue-600 dark:text-blue-400 hover:underline">
                ...
                <!-- Update Button -->
                <div class="ml-6">
                    <a href="{{ route('newanimals.edit', $animal->animal_id) }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition duration-300">
        ...
        <div class="mt-8">
            ...
            <!-- Filter Form -->
            <form id="filterForm" method="GET" action="{{ route('newanimals.profile', ['animal_id' => $animal->animal_id]) }}" class="mt-4">
