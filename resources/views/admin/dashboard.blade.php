                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    <td class="px-6 py-4">
                                        @if($transaction->owner->user->profile_image)
                                            <img src="{{ asset('storage/' . $transaction->owner->user->profile_image) }}" 
                                                 alt="Profile Image" 
                                    ...
                                    <td class="px-6 py-4">
                                        <a href="{{ route('owners.profile-owner', $transaction->owner->owner_id) }}" 
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @else
                                            <span class="text-gray-400">No Veterinarian Selected</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 text-gray-600">{{ $transaction->technician->full_name ?? 'N/A' }}</td>
                                    <td class="px-6 py-4 text-gray-600">
                                        <div class="flex flex-col">
                                            <span>{{ $transaction->transactionType->type_name ?? 'Unknown' }}</span>
                                            @if($transaction->transactionSubtype)
                                                <span class="text-sm text-gray-400">{{ $transaction->transactionSubtype->subtype_name ?? 'Unknown' }}</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
