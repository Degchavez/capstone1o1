        ...
        <div class="max-w-[100%] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="flex flex-col w-full">
                <div class="-m-1.5 overflow-x-auto">
                        ...
                        <div class="bg-white border border-gray-300 rounded-xl shadow-lg overflow-hidden dark:bg-neutral-800 dark:border-neutral-700">
                            ...
                            <div class="px-6 py-4 grid gap-4 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
                                ...
                                <div class="flex space-x-3 items-center">
                                    <!-- Search Bar -->
                                    <form method="GET" action="{{ route('rec-owners') }}" class="flex flex-wrap gap-3 items-center">
                                        <input 
                                            type="text" 
                                            name="search" 
                    ...
                    <a href="{{ route('reg-owner') }}" class="bg-green-600 text-white text-sm font-semibold px-6 py-2 rounded-lg hover:bg-green-700 focus:outline-none shadow-md transition duration-200">
                        Add
                    </a>
                    
                                        <!-- Reset Button -->
                                        <a 
                                            href="{{ route('rec-owners') }}" 
                                    ...
                                    <tbody class="bg-white dark:bg-neutral-700 divide-y divide-gray-200 dark:divide-neutral-600">
                                        @forelse ($owners as $owner)
                                            <tr>
                                                ...
                                                <!-- Name -->
                                                <td class="px-4 py-3 text-sm">
                                                    <a href="{{ route('rec.profile-owner', $owner->owner_id) }}" class="text-blue-500 hover:text-blue-700 font-bold">
                                                        {{ $owner->complete_name }}
                                                    </a>
                                                </td>
