            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="space-y-6 lg:col-span-1">
                    <div class="bg-gray-50 p-6 rounded-lg shadow-md mb-6">
                        ...
                        <form method="GET" action="{{ route('vet.profile-owner', ['owner_id' => $owner->owner_id]) }}" class="space-y-4" id="filterForm">
                                        ...
                                        @foreach($animals as $animal)
                                            <tr class="hover:bg-gray-100 transition-all">
                                                ...
                                                <td class="px-6 py-3 text-gray-800">
                                                    <b>
                                                        <a href="{{ route('vet.profile', ['animal_id' => $animal->animal_id]) }}" class="text-blue-600 hover:text-blue-800">
                                                            {{ $animal->name }}
                                                            @if ($animal->is_group)
                                                                ({{$animal->group_count}}
                                                             )
