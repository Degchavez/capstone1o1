        ...
        @endif
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('admin-owners') }}" 
                   class="bg-green-500 text-white px-4 py-2 rounded-lg shadow hover:bg-green-600 transition-colors duration-300">
                    Go Back to Owners List
                </a>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="space-y-6 lg:col-span-1">
                    <div class="bg-gray-50 p-6 rounded-lg shadow-md mb-6">
                        ...
                        <form method="GET" action="{{ route('owners.profile-owner', ['owner_id' => $owner->owner_id]) }}" class="space-y-4" id="filterForm">
                            ...
                            <table class="min-w-full bg-white border border-gray-300 rounded-lg shadow-md">
                                    <thead class="bg-green-100">
                                        <tr>
                                            ...
                                            <th class="px-6 py-3 text-left text-sm font-semibold text-gray-700">Vaccination Status</th>
                                        ...
                                        @foreach($animals as $animal)
                                            <tr class="hover:bg-gray-100 transition-all">
                                                ...
                                                <td class="px-6 py-3 text-gray-800">
                                                    <b>
                                                        <a href="{{ route('animals.profile', ['animal_id' => $animal->animal_id]) }}" class="text-blue-600 hover:text-blue-800">
                                                            {{ $animal->name }}
                                                            @if ($animal->is_group)
                                                                ({{$animal->group_count}}
                                                             )
                                                    ...
                                                    @endif
                                                     ...
                                                     <td class="px-6 py-3 text-sm">
                                                        ...
                                                        <div class="flex flex-col space-y-2">     
                                                            ...
                                                            <!-- Delete Button -->
                                                            <form action="{{ route('owner.deleteAnimal', ['animal_id' => $animal->animal_id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this animal?')">
                                                                @csrf
                                                                @method('DELETE')
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg shadow-md mb-6">
                        ...
                        @if($owner->transactions->isNotEmpty())
                            <div class="space-y-4">
                              ...
                              <!-- Delete Button -->
                              <form action="{{ route('transaction.remove', ['transaction_id' => $transaction->transaction_id]) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this animal?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="text-red-500 hover:text-red-700 px-4 py-2 border border-red-500 rounded-md">
                                    Delete
